...
export const diffeqEntries: DiffeqEntry[] = [
  ...
  },
  {
    ...
    method: "Antidifferentiation",
    category: "Direct integration equations",
    solution: "y = 2/sqrt(x) + C",
    solutionLatex: "y = \\frac{2}{\\sqrt{x}} + C",
    tags: [],
    takeaway: directIntegrationTakeaway,
  ...
  },
  {
    ...
    method: "Antidifferentiation",
    category: "Direct integration equations",
    solution: "y = -1/2*x^(-3/2) + C",
    solutionLatex: "y = -\\frac{1}{2}x^{-3/2} + C",
    tags: [],
    takeaway: directIntegrationTakeaway,
  ...
  },
  {
    ...
    method: "Antidifferentiation",
    category: "Direct integration equations",
    solution: "y = 2x^3 + 4x^-2 + C",
    solutionLatex: "y = 2x^3 + 4x^{-2} + C",
    tags: [],
    takeaway: directIntegrationTakeaway,
